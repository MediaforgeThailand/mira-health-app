    ...
    class StreamableComponent extends React.Component {
      ...
      componentDidMount() {
        ...
        if (typeof window !== "undefined") {
          window.__dcInstances = window.__dcInstances || {};
          window.__dcInstances[this.__name] = this.logic;
          window.dispatchEvent(new CustomEvent("mira:dc-instance", {
            detail: { name: this.__name, logic: this.logic }
          }));
        }
        try {
      ...
      componentWillUnmount() {
        ...
        if (typeof window !== "undefined" && window.__dcInstances && window.__dcInstances[this.__name] === this.logic) {
          delete window.__dcInstances[this.__name];
        }
        if (!this.__needsDidMount) {
          try {
            this.logic.componentWillUnmount();
