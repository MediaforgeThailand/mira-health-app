...
export const showcaseEntries: readonly ShowcaseEntry[] = [
  ...
  },
  {
    auth: 'admin',
    demoOrder: 5,
    description_th: 'หน้าเพิ่มและจัดการสมาชิก tenant ด้วยบัญชีแอดมิน ใช้เปิดสิทธิ์หมอหรือพนักงานก่อนสร้าง referral code ของตัวเอง.',
    href: '/admin/members',
    id: 'admin-members',
    label_en: 'Team Member Management',
    label_th: 'สมาชิกทีม',
    module: 'admin',
    path: '/admin/members',
    poster: null,
