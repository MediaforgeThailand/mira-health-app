...
const designVersion = '20260705b';
// The standalone demo deployment serves the Expo web export at the domain root
// (no "/showcase" base URL), so the design bundle in public/mira-design/ is
// exposed at "/mira-design/…".
const designSrc = `/mira-design/mira-core-system.dc?v=${designVersion}`;
